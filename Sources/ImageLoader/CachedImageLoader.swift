...
public enum CachedImageLoaderError: Error {
...
public final class CachedImageLoader {
    ...
    public func loadImage(from url: NSURL, completion: @escaping (Result<UIImage, Error>) -> Void) throws -> UUID? {
        ...
        let dataTask = URLSession.shared.dataTask(with: url as URL) { data, response, error in
            ...
            guard let error = error else {
                ...
                result = .failure(CachedImageLoaderError.errorDecoding)
                return
            }
    ...
    public func cancelLoading(id: UUID) {
